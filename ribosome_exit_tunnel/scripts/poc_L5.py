...
if rerun_alignment:
    ...
    seqs = seqs + read_rna_file(chain)
    # Saves to "input_sequences_uL4.fasta"
    save_fasta(seqs, chain)

    # Perform multiple sequence alignment    
    mafft_command = f"mafft --auto --leavegappyregion {"data/output/input_sequences_28S.fasta"} > {"data/output/aligned_sequences_28S.fasta"}"
    ...
    conserved_positions = cherry_pick('28S', alignment[0], conserved_positions, distance_threshold, rna=True)
